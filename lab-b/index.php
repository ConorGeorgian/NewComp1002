...
<!-- STEP 9: Validate your completed page at 	 and repair any errors - then .zip all your files up and submit your work -->
<!-- STEP 10: Upload all files for this lab to your Web server in https://YOUR-SERVERNAME-HERE/week5/lab5/ (URL example would be on a Microsoft Azure server instance) -->
			<img src="images/html-logo.svg" alt="A reimagination of the HTML logo in the style of the LEGO logo." width="150" height="150">
...
<figure>
<img src="images/mini-figure.png" alt="A simple 3d graphic of a lego mini figure." width="176" height="285">
